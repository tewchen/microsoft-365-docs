...
1. Options:
    ...
    - DeviceId
    - HardwareId
    - InstancePathId: although InstancePathId is a string uniquely identifies the device in the system, for example, USBSTOR\DISK&VEN_GENERIC&PROD_FLASH_DISK&REV_8.07\8735B611&0, the number at the end, e.g. '&0' in previous value, representing the avaliable slot may change in different machine. You can use wildcard to prevent this dynamic value, e.g. USBSTOR\DISK&VEN_GENERIC&PROD_FLASH_DISK&REV_8.07\8735B611*
    - FriendlyNameId
    - SerialNumberId
    - VID
    - PID
